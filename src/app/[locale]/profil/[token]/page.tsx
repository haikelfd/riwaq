...
import { fetchSellerByToken, fetchSellerListings } from '@/lib/actions/sellers';
...
export default function ProfileManagePage() {
  ...
  useEffect(() => {
    async function loadData() {
      const sellerData = await fetchSellerByToken(token);
      ...
      const listingData = await fetchSellerListings(sellerData.id);
