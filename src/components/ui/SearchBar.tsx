      ...
      <div className="relative group">
        <div className="absolute inset-y-0 left-0 flex items-center pointer-events-none">
          <svg
            ...
            className={`text-slate-400 group-focus-within:text-brand-500 transition-colors ${large ? 'w-5 h-5 ml-5' : 'w-4 h-4 ml-4'}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2}
        ...
        <input
          ...
          className={`
            ...
            ${large ? 'pl-14 pr-14 sm:pr-36 py-4 sm:py-5 text-sm sm:text-base' : 'pl-11 pr-24 py-3 text-sm'}
          `}
        />
        <button
          type="submit"
